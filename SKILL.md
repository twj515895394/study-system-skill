...
初始化后会生成 `STATE.json`、核心 Markdown 看板、`QUESTION-PARKING-LOT.md`、`REVIEW-SCHEDULE.md`，并把课程/交接/学习记录/复习测验/多课型模板复制到 `study/_templates/`，方便跨 Agent 续接。
...
先根据课程目标选择课型，详见 `references/lesson-flow.md`：

- 概念入门：`study/_templates/lesson-types/concept-primer.md.template`
- 源码调用链：`study/_templates/lesson-types/code-trace.md.template`
- 架构拆解：`study/_templates/lesson-types/architecture-walkthrough.md.template`
- 论文阅读：`study/_templates/lesson-types/paper-reading.md.template`
- 练习/错题复盘：`study/_templates/lesson-types/exercise-review.md.template`
- 动手实现：`study/_templates/lesson-types/implementation-lab.md.template`
- 阶段复盘：`study/_templates/lesson-types/phase-review.md.template`
- 通用课：`study/_templates/lesson.md.template`
